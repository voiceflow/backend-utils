...
import { RateLimitManager } from '../../src/services/rateLimit';
...
describe('rateLimit manager unit tests', () => {
  ...
  describe('setHeaders', () => {
    it('works', () => {
      const service = new RateLimitManager({} as any, {} as any);
  ...
  describe('consume', () => {
    it('private', async () => {
      ...
      const service = new RateLimitManager(services as any, config as any);
      ...
      expect(services.rateLimitClient.private.consume.args).to.eql([[req.headers.authorization]]);
    ...
    it('public', async () => {
      ...
      expect(services.rateLimitClient.public.consume.args).to.eql([[req.params.versionID]]);
